...
// load csv data
d3.csv("./Dataset/Day6_CloudType.csv").then(function (data) {
    ...
    svg_6.selectAll("chart_5")
        ...
        .on('mouseover', function (event, d) {
            ...
            d3.select("#hover_chart6")
                .append("text")
                .attr("id", "hover_text")
                .attr("x", 25)
                .attr("y", function (d, i) { return parseFloat(barY) + parseFloat(bar_height) - 15; })
                .text("was observed in " + d.count + " out of 100 observations (" + d.percent + "%)")
