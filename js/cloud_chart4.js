...
d3.csv("./Dataset/Day4_CloudType.csv").then(function (data) {
    ...
    svg_4.selectAll("chart_4")
        ...
        .on('mouseover', function (event, d) {
            ...
            d3.select("#hover_chart4")
                .append("text")
                .attr("id", "hover_text")
                .attr("x", 25)
                .attr("y", function (d, i) { return parseFloat(barY) + parseFloat(bar_height) - 15; })
                .text("was observed in " + d.count + " out of 172 observations (" + d.percent + "%)")
