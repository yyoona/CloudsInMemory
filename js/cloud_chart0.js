...
d3.csv("./Dataset/All_CloudType.csv").then(function (data) {
    ...
    // get the extent for the percent data
    // var extent_percent = d3.extent(data, function (d) {
    ...
    svg_0.selectAll("chart_0")
        ...
        .on('mouseover', function (event, d) {
            ...
            d3.select("#hover_chart0")
                .append("text")
                .attr("id", "hover_text")
                .attr("x", 25)
                .attr("y", function (d, i) { return parseFloat(barY) + parseFloat(bar_height) - 15; })
                .text("was observed in " + d.count + " out of 580 observations (" + d.percent + "%)")
