...
// load csv data
d3.csv("./Dataset/Day2_CloudType.csv").then(function (data) {
    ...
    svg_2.selectAll("chart_2")
        ...
        .on('mouseover', function (event, d) {
            ...
            d3.select("#hover_chart2")
                .append("text")
                .attr("id", "hover_text")
                .attr("x", 25)
                .attr("y", function (d, i) { return parseFloat(barY) + parseFloat(bar_height) - 15; })
                .text("was observed in " + d.count + " out of 52 observations (" + d.percent + "%)")
