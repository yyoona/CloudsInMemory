...
// load csv data
d3.csv("/Dataset/Day1_CloudType.csv").then(function (data) {
    ...
    svg_1.selectAll("chart_1")
        ...
        .on('mouseover', function (event, d) {
            ...
            d3.select("#hover_chart1")
                .append("text")
                .attr("id", "hover_text")
                .attr("x", 25)
                .attr("y", function (d, i) { return parseFloat(barY) + parseFloat(bar_height) - 15; })
                .text("was observed in " + d.count + " out of 94 observations (" + d.percent + "%)")
